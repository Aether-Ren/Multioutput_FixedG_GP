...
output_file = 'Result/L.DKGP_21_result.csv'
...
for row_idx in range(test_y_21.shape[0]):
    ...
    MultitaskGP_models, MultitaskGP_likelihoods = Training.train_one_row_NNLocalGP_Parallel(
        local_train_x, local_train_y, test_y_21, row_idx, 
        feature_extractor_class = FeatureE.FeatureExtractor_4, 
        covar_type = 'RQ', k_num = 500, lr=0.05, 
...
# nohup python DkGP_21.py > DkGP_21out.log 2>&1 &