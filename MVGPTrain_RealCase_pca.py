...
Y_train_std = pd.read_csv('RealCase/RealCase_Y_train_pca.csv', header=None, delimiter=',').values
Y_test_std = pd.read_csv('RealCase/RealCase_Y_test_pca.csv', header=None, delimiter=',').values
...
num_latents_candidates = [36]
num_inducing_candidates = [400]
covar_type_candidates = ['RBF']
...
print("save 'multitask_gp_checkpoint_Realcase_pca.pth'。")


# nohup python MVGPTrain_RealCase_pca.py > MVGPTrain_RealCase_pcaout.log 2>&1 &