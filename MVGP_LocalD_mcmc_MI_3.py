...
X_test = pd.read_csv('LocalDisease/X_MI_3.csv', header=None, delimiter=',').values

Y_train_pca = pd.read_csv('Data/Data20260110/Y_data_train_pca.csv', header=None, delimiter=',').values
Y_test_21 = pd.read_csv('LocalDisease/Y_data_MI_3_pca.csv', header=None, delimiter=',').values
...
mcmc_dir = 'LocalDisease/Result/MVGP_MI_3_mcmc_result'
...
# nohup python MVGP_LocalD_mcmc_MI_3.py > MVGP_LocalD_mcmc_MI_3out.log 2>&1 &